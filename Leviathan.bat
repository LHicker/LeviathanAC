...
namespace n$namespace
{
	public class c$class
	{
		...
		public static void Init(string toggle, string hide, string disable) {
			...
			Console.WriteLine("");
			Console.WriteLine(" _     _______     _____    _  _____ _   _    _    _   _ ");
			Console.WriteLine("| |   | ____\ \   / /_ _|  / \|_   _| | | |  / \  | \ | |"); 
			Console.WriteLine("| |   |  _|  \ \ / / | |  / _ \ | | | |_| | / _ \ |  \| |"); 
			Console.WriteLine("| |___| |___  \ V /  | | / ___ \| | |  _  |/ ___ \| |\  |"); 
			Console.WriteLine("|_____|_____|  \_/  |___/_/   \_\_| |_| |_/_/   \_\_| \_|"); 
			Console.WriteLine("|F|a|c|t|i|o|n| |A|u|t|o|c|l|i|c|k|e|r|"); 
			Console.WriteLine("");
